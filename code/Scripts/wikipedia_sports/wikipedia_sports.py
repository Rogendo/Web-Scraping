...
BATCH_SIZE = 100  # Number of articles to scrape per batch
...
#  topics (will be used if no topics file is found)
default_sports_topics = [
    "baseball",
    "soccer",
    "badminton",
    "cricket",
...
topics_file = "./sports.txt"
if os.path.exists(topics_file):
    TOPICS = load_topics(topics_file)
    if not TOPICS:
        print("No topics loaded from file; using default law topics.")
        TOPICS = default_sports_topics
else:
    print(f"{topics_file} not found. Using default law topics.")
    TOPICS = default_sports_topics
